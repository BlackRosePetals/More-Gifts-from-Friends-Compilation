...
For updates, I recommend removing the mod(s) that will be updated. (Deleting the "[MFM] Gifts from Friends Compilation" folder from the installation folder to removes all the mods at once.)
